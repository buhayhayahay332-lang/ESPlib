...
local ESP = {
    ...
    Drawing = {
        ...
        Boxes = {
            ...
            RotationSpeed = 300,
            Gradient      = true,
            GradientRGB1  = Color3.fromRGB(0, 255, 255),
            GradientRGB2  = Color3.fromRGB(0, 50, 255),
            GradientFill  = true,
            GradientFillRGB1 = Color3.fromRGB(0, 255, 255),
            GradientFillRGB2 = Color3.fromRGB(0, 50, 255),
            Filled = {
                Enabled      = false,
                Transparency = 0.75,
